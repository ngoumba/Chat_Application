...
import ucad.esp.dgi.chatapplication.Adapter.MediaAdapter;
import ucad.esp.dgi.chatapplication.Models.Chats.Message;
import ucad.esp.dgi.chatapplication.Adapter.MessageAdapter;
import ucad.esp.dgi.chatapplication.Models.Ressources.SendNotification;
        ...
        mChatMessagesDb.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                if (dataSnapshot.exists()) {
                    ...
                    Message mMessage = new Message(dataSnapshot.getKey(), creatorID, text, mediaUrlList);
