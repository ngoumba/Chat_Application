...
public class StatusActivity extends AppCompatActivity implements StoriesProgressView.StoriesListener {
    ...
    private final int[] resources = new int[]{
            com.google.firebase.messaging.R.drawable.icon_with_gradient,
            com.google.firebase.messaging.R.drawable.adaptive_icon
    };
    ...
    public void onComplete() {
        ...
        Intent i = new Intent(StatusActivity.this, Main.class);
        startActivity(i);
        finish();
    }
